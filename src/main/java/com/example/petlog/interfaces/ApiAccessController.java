package com.example.petlog.interfaces;

import com.example.petlog.security.service.JwtUtil;
...
public class ApiAccessController {
    ...
    @Autowired
    public ApiAccessController(UserService theUserService) { this.userService = theUserService; }
